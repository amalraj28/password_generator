...
random_sym = random.choices(symbol, k=count_symbol)    # Generates a randomly generated list of length k from the list symbol
random_num = random.choices(number_str, k=count_num)  # Generates a randomly generated list of length k from the list number_str
random_alpha = random.choices(alphabet, k=count_letters)  # Generates a randomly generated list of length k from the list alphabet
...
password = "".join(final_list)  # Converts the list to password
